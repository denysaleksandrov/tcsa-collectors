...
class MultiThreadedKafkaCollector(StreamCollector):
    ...
    def _consume(self):
        ...
        consumer_config['sasl.mechanism']= self._config.get_advance_inputs.get_sasl_mechanism
        consumer_config['security.protocol']= self._config.get_advance_inputs.get_security_protocol
        consumer_config['sasl.username'] = self._config.get_advance_inputs.get_username
        consumer_config['sasl.password'] = self._config.get_advance_inputs.get_password
